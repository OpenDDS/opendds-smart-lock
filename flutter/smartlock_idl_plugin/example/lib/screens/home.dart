...
enum InitState { begin, downloading, downloaded, started }
...
class _HomeState extends State<Home> {
  ...
  InitState _state = InitState.begin;
  ...
  Future<Map<String, String>> _downloadCerts(String directory) async {
    setState(() => _state = InitState.downloading);
    ...
    try {
      ...
      if (response.statusCode == 303) {
        ...
        if (response.statusCode == 200) {
          ...
          setState(() => _state = InitState.downloaded);
        }
      }
    } catch (err) {
      setState(() => _text.add(err.toString()));
    }
    return certs;
  }
  ...
  String _getStateMessage() {
    switch (_state) {
      ...
      case InitState.downloading:
        return "We have begun downloading the certs.";
      case InitState.downloaded:
        return "We have downloaded all of the certs.";
      case InitState.started:
        return "A SmartLock bridge was created and started in initState()";
    }
  }
